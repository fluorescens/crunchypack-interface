...
public class CardsManager extends JFrame{
    //the one and only cards object that holds the panel components and porvides navigation. 
     ...
     public CardsManager() {
         //the common jframe that manager nagivation; universal buttons and frame elements. 
